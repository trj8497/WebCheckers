...
define(function(require){
  ...
  /**
   * flash the hint when press the hint button
   */
  PlayController.prototype.getHint = function getHint() {
      AjaxUtils.callServer('/hint',
         ...
         function handleResponse(message) {
           console.log(message);
            ...
            this._boardController.setHintFlasher(message);
            this.disableButton(PlayModeConstants.HINT_BUTTON_ID);
         }
  };
