...
define(function(require){
  ...
  /**
   * get the hint to flash
   */
  BoardController.prototype.setHintFlasher = function setHintFlasher(message) {
      var i;
      for(i = 0; i < message.length;i++){
      var $space = this.getSpace$(message[i]);
      $space.addClass(PENDING_CLASS);}
  };
